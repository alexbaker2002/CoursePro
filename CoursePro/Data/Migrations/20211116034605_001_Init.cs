        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DaysOffered = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Classifications_ClassificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_TextBooks_TextBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextBooksId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTextBook", x => new { x.CoursesId, x.TextBooksId });
                    table.ForeignKey(
                        name: "FK_CourseTextBook_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseTextBook_TextBooks_TextBooksId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TextBookId",
                table: "AspNetUsers",
                column: "TextBookId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_ClassificationId",
                table: "Courses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTextBook_TextBooksId",
                table: "CourseTextBook",
                column: "TextBooksId");
        }
